...
const SliderNumberWrapper: FC<SliderNumberWrapperProps> = (props: SliderNumberWrapperProps) => {
...
const SliderNumberItem: FC<ISliderNumberItemProps> = (props: ISliderNumberItemProps) => {
    const {} = props
