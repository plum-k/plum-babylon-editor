...
const TextureAttribute: FC<TextureAttributeProps> = (props: TextureAttributeProps) => {
...
const TextureAttributeItem: FC<TextureAttributeItemProps> = (props: TextureAttributeItemProps) => {
    const {} = props;
