...
import {BaseItemProps, useObjectAttribute} from "@plum-render/common-ui";
 ...
 * @constructor
 */
const BabylonTextureItem: FC<BabylonTextureItemProps> = (props: BabylonTextureItemProps) => {
...
export default BabylonTextureItem;
